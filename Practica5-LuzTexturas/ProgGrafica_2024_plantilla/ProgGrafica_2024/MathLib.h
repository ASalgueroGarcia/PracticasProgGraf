...
inline Vector2f make_vector2f(float x, float y) {
	Vector2f vres;
	vres.x = x, vres.y = y;
	return vres;
}
...
inline Vector3f make_vector3f(float x, float y, float z) {
	Vector3f vres;
	vres.x = x, vres.y = y, vres.z = z;
	return vres;
}
...
inline float dot_product(Vector3f v1, Vector3f v2) {
	return v1.x * v2.x + v1.y * v2.y + v1.z * v2.z;
}

inline Vector3f cross_product(Vector3f v1, Vector3f v2) {
	return make_vector3f(v1.y*v2.z - v1.z*v2.y, v1.z*v2.x - v1.x*v2.z, v1.x*v2.y - v1.y*v2.x);
}
